...
const topicTemplates = [
  {
    id: "budgetAdvance",
    priority: 130,
    triggers: ["내년도 예산", "차년도 예산", "차년도 직접비", "미리 당겨", "사전집행", "연도별 연구개발비"],
    boostTerms: ["사용계획 변경", "사전 승인", "협약 변경", "산학협력단", "중앙행정기관", "연구수당"],
    title: "차년도 예산의 당해연도 사전집행",
    rows: [
      ["결론", "연구자가 차년도 예산을 임의로 당겨 먼저 집행할 수는 없습니다. 해당 사업에서 허용하고 정식 사전승인 또는 협약·연구개발비 사용계획 변경이 완료된 경우에만 집행할 수 있습니다."],
      ["필요 절차", "집행 전 산학협력단에 사유와 조정 금액·비목·연구 일정·필요성을 제출하고, 지원기관 또는 중앙행정기관의 승인 대상인지 확인합니다. 승인 결과와 변경된 실행예산이 시스템에 반영된 뒤 집행합니다."],
      ["주의", "차년도 예산이 아직 배정되지 않았거나 시스템 예산현액에 반영되지 않았다면 먼저 사용하지 않습니다. 연구수당은 단계 간 이월이 제한되므로 직접비와 동일하게 취급하면 안 됩니다."],
      ["이미 집행한 경우", "개인이 임의로 입금해 끝내지 말고 산학협력단에 즉시 알린 뒤 결제 취소, 비목 정정, 반납 또는 환수 절차와 필요한 소명서류를 안내받아 처리합니다."],
    ],
  },
  {
    id: "travelSettlement",
